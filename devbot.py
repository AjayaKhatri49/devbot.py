...
if choice.lower() == 'n':
    ...
    accessToken = "Bearer YjgxZWU5M2UtMjM3Yy00ZGVlLThmNWItNjBiY2JhNDVkNTgzNjgwNTA3ZTYtMTk4_PC75_f1a9c66d-3eff-454d-9c51-a4e0afcd770b"
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "ZtSmdgIjTmvCF2qzqYyekDwx6sQLhVwE"
                               }
...
# 11. Complete the code to format the response message.
        ...
        sunsetTime = "(4:39:56 PM)"    
        dayLengthSeconds = 31095
        responseMessage = f"In {location} the sun will rise at {sunriseTime} and will set at {sunsetTime}. The day will last {dayLengthSeconds} seconds."
